...
write.csv(finaloutput,file="PMMA_qrad_location_trainaccuracy.csv",row.names=T)
...
write.csv(finalvaloutput, "PMMA_qrad_location_testaccuracy.csv", row.names = T)



save(m.rgasp, file = "PMMA_qrad_location_model.rda")