...
## Train/test based on location
#Load data
data <- read_csv("PMMAboundary_GASP_location_train.csv") 
...
write.csv(finaloutput,file="PMMA_rdot_location_trainaccuracy.csv",row.names=T)

#Validation/testing set
validation_data <- read_csv("PMMAboundary_GASP_location_test.csv")
#Scale
...
write.csv(finalvaloutput,file="PMMA_rdot_location_testaccuracy.csv",row.names=T)

save(m.rgasp, file = "PMMA_rdot_location_model.rda")
